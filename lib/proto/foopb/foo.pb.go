...
var file_foo_foo_proto_goTypes = []any{
	(*Foo)(nil),          // 0: foo.Foo
...
func file_foo_foo_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_foo_foo_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Foo); i {
			case 0:
				return &v.state
			case 1:
		...
		file_foo_foo_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_foo_foo_proto_msgTypes[2].Exporter = func(v any, i int) any {
