...
Taken from https://github.com/aspect-build/aspect-cli/blob/main/bazel/go/write_go_generated_source_files.bzl
"""
...
def write_go_proto_sources(name, src, output_files, **kwargs):
